...
public class SupermercadoTIA {
	...
	public static void main(String[] args) {
		...
		RegistroDocumentos rd = new RegistroDocumentos();
		...
		try {
			...
			clientela.agregarCliente(c1);
			clientela.agregarCliente(c2);
			clientela.agregarCliente(c3);
			...
			rd.guardarClientes(clientela.getClientela(), "Clientes.txt");
